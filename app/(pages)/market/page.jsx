                        ...
                        <tr key={index} className="  2xl:text-md xl:text-base">
                          ...
                          >
                            ...
                            >
                              ...
                              {(
                                market?.quotes.USD.percent_change_1h * 100
                              ).toFixed(1)}
                              %
                            </div>
                          </td>
                          ...
                          <td className="  text-center whitespace-nowrap  text-white ">
                            ...
                            >
                              ...
                              {(
                                market?.quotes.USD.percent_change_24h * 100
                              ).toFixed(1)}
                              %
                            </div>
                          </td>
                          <td className="  text-center whitespace-nowrap  text-white ">
                            ...
                            >
                              ...
                              {(
                                market?.quotes.USD.percent_change_7d * 100
                              ).toFixed(1)}
                              %
                            </div>
                          </td>
                          ...
                          <td className="  text-center whitespace-nowrap  text-white ">
                            ${market?.quotes.USD.market_cap.toFixed(2)}
                          </td>
