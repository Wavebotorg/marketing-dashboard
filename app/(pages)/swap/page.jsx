...
const Swap = () => {
  ...
  const getWalletBalance = async (networkName) => {
    ...
    console.log("🚀 ~ getWalletBalance ~ selectedNetwork:", selectedNetwork);
    ...
    if (selectedNetwork && selectedNetwork.name !== "Solana") {
      console.log(
      ...
      console.log("🚀 ~ getWalletBalance ~ myDatawallet:", myDatawallet);
