...
const ForgotPassword = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center bgImage">
      ...
      <div className="px-5 sm:px-7 md:px-7 2xl:px-14 bg-black shadow-xl py-8  flex-container md:w-[26rem] lg:w-[29rem] 2xl:w-[35rem]  xl:w-[31.5rem] sm:py-8 md:py-8 lg:py-10  2xl:py-14   rounded-3xl mt-8 sm:mt-8 md:mt-10 lg:mt-10 xl:mt-12">
