  ...
  return (
    <div className="container">
      ...
      {/* <div className="container ">
        <div className="rounded-lg ">
          <div className="bg-[#1C1C1C] text-white h-96 overflow-auto rounded-lg">
            <div className="grid grid-cols-7 bg-[#1C1C1C] sticky top-0">
              <div className="px-4 py-2">Market</div>
              <div className="px-4 py-2">Sell</div>
              <div className="px-4 py-2">Buy</div>
              <div className="px-4 py-2">52W Range </div>
              <div className="px-4 py-2">Changes 1D</div>
              <div className="px-4 py-2">Sentiments</div>
            ...
            {watchListData.map((item, index) => (
              <div key={index} className="grid grid-cols-7">
                ...
                <div>
                  <div className="px-4 py-2">{item.Sell}</div>
                </div>
                <div>
                  <div className="px-4 py-2">{item.Buy}</div>
                </div>
                <div className="px-4 py-2 w-96">{item.WRange}</div>
                <div>
                  <div className="px-8 py-2 ">{item.ChangesD}</div>
                  <p className="text-sm text-red-700 px-7">-(-0.73%)</p>
                </div>
