...
const TokenDashboard = () => {
  return (
    <>
      <div>
        <p className="text-blue-400 text-3xl font-medium w-96 ">
          Revenue Share Dashboard
        </p>
        <div className="flex gap-6 mt-5 ">
          <div className=" rounded-lg p-4 bg-[#1C1C1C] flex justify-center gap-2 ">
      ...
      <div className="mt-6 flex">
        ...
        <div className="flex ml-auto gap-3">
          <div>
            <button className="rounded-lg bg-blue-500 p-1">Claim Wave</button>
          </div>
          <div>
            <button className="rounded-lg bg-blue-500 p-1">Claim ETH</button>
          </div>
          <div>
            <button className="rounded-lg bg-blue-500 p-1">Claim SOL</button>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end mt-44">
        <div>
          <label>Rows per page </label>
          <select name="select Row" className="bg-blue-500 rounded-lg p-1">
            <option value="Show 1">Show 1</option>
            <option value="Show 2">Show 2</option>
            <option value="Show 3">Show 3</option>
            <option value="Show 4">Show 4</option>
            <option value="Show 5" selected>
              Show 5
            </option>
          </select>
        </div>
